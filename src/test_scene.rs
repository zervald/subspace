...
fn spawn_test_lifetime(
    ...
    let id = commands
        .spawn((
            ...
            Transform::from_xyz(0., -50., RadarZOrdering::Ships.as_f32()),
        ))
        .id();
    ...
    commands.spawn((
        ...
        Transform::from_xyz(10., -50., RadarZOrdering::Ships.as_f32()),
    ));
    ...
    commands.spawn((
        ...
        Lifetime::from(id),
        Transform::from_xyz(20., -50., RadarZOrdering::Ships.as_f32()),
    ));
}
